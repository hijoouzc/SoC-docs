# 0 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
...
# 4 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\system-top.dts" 2
# 1 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
  xlnx,rable = <0>;
...
# 5 "E:\\EDABK\\Workspace\\.rigel_lopper_temp_platform\\system_wrapper\\hw\\sdt\\system-top.dts" 2
/ {
 board = "pynq-z2";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x41200000 &switches 0x41200000 0x10000>,
         <0x41210000 &buttons 0x41210000 0x10000>,
